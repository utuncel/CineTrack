...
public class AverageRatingStatisticController {
    ...
    public void addAverageRatingStatistic(List<Cinematic> cinematics, List<Type> types) throws IOException {
        ...
        controller.setData(
                String.valueOf(myAverageRatingStrategy.calculate(cinematics, types)),
                String.valueOf(imdbAverageRatingStrategy.calculate(cinematics, types))
        );
