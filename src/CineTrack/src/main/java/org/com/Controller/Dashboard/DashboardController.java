...
public class DashboardController {
    ...
    private void addAverageRatingChart() throws IOException {
        ...
        averageRatingStatisticController.addAverageRatingStatistic(dashboardModel.getCinematics(), dashboardModel.getTypes(), dashboardModel.getStates());
    }
    ...
    private void addGenreCountChart() throws IOException {
        ...
        genreCountController.addGenreCountStatistic(dashboardModel.getCinematics(), dashboardModel.getTypes(), dashboardModel.getStates());
    }
    ...
    private void addStateCountChart() throws IOException {
        ...
        stateCountController.addStateCountStatistic(dashboardModel.getCinematics(), dashboardModel.getTypes(), dashboardModel.getStates());
    }

    private void addTypeCountChart() throws IOException {
        TypeCountStatisticController typeCountController = new TypeCountStatisticController(chartContainer);
