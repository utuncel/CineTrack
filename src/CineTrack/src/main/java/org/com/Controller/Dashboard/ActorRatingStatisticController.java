...
import org.com.Models.Statistic.ActorRatingsStrategy;
...
public class ActorRatingStatisticController {
    ...
    public void addActorRatingStatistic(List<Cinematic> cinematics, List<Type> types, List<State> states) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Dashboard/ActorRatingStatisticView.fxml"));
    ...
    private void updateChart(List<Cinematic> cinematics, List<Type> types, List<State> states) {
        ...
        Map<String, List<Double>> actorRatingData = actorRatingStrategy.calculate(cinematics, types, states);
